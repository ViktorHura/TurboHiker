...
turbohiker::Utils::Vector &turbohiker::Utils::Vector::add(const turbohiker::Utils::Vector &vec2) {
    x_ += vec2.x();
    y_ += vec2.y();
...
turbohiker::Utils::Vector &turbohiker::Utils::Vector::set(const turbohiker::Utils::Vector &vec2) {
    x_ = vec2.x();
    y_ = vec2.y();
    return *this;
}
