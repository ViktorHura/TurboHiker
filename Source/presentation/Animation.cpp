...
turbohikerSFML::Animation::Animation(int frames, double framerate,
                                     bool playonce) {
...
turbohikerSFML::Animation &
turbohikerSFML::Animation::setDuration(double duration) {
...
turbohikerSFML::Animation &
turbohikerSFML::Animation::update(double delta, sf::Sprite &sprite) {
  if (playing) {
    animationtimer += delta; // increment animation timer

    double singletimer = std::fmod(
        animationtimer, duration()); // timer of a single loop of animation
...
bool turbohikerSFML::Animation::isPlaying() { return playing; }
