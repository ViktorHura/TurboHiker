...
turbohikerSFML::PassingHiker2::PassingHiker2(
...
void turbohikerSFML::PassingHiker2::react() {
  ...
  int i = turbohiker::Random::Int(0, reactions.size() -
                                         1); // choose random reaction
  reactText.setString(reactions[i]);
  ping.play();
}

std::vector<std::wstring> turbohikerSFML::PassingHiker2::reactions = {
    L"ﾟ口ﾟ",  L"〇o〇",     L"౦ ‸ ౦",    L"⊙_⊙",        L"ノωヽ",
    L"º □ º", L"ヽ(°〇°)ﾉ", L"┌( >_<)┘", L"( つ＞＜)つ"};